...
def read_params():
    ...
    if active_var_1.get():
        peak1 = []
        peak1.append(float(sigma_1.get()))
        peak1.append(float(sigma_0_1.get()))
    ...
    if active_var_2.get():
        peak2 = []
        peak2.append(float(sigma_2.get()))
        peak2.append(float(sigma_0_2.get()))
    ...
    if active_var_3.get():
        peak3 = []
        peak3.append(float(sigma_3.get()))
        peak3.append(float(sigma_0_3.get()))
...
def map_maker():
    ...
    aggregated_data = agg.agg_data(data, float(min_size.get()), float(max_size.get())+float(size_step.get()), float(size_step.get()), read_params(),
...
def calibrate():
    ...
    sigma_1.delete(0, tk.END)
    sigma_1.insert(0, result[0][0])
    sigma_1.config(foreground="green")
    sigma_0_1.delete(0, tk.END)
    sigma_0_1.insert(0, result[0][1])
    sigma_0_1.config(foreground="green")
...
def rbtn_select(event):
    ...
    if event.widget["value"] == 1:
        ...
        size_step.config(state="disabled")
        ...
        sigma_1.config(state="readonly")
        sigma_0_1.config(state="readonly")
        ...
        sigma_2.config(state="readonly")
        sigma_0_2.config(state="readonly")
        ...
        sigma_3.config(state="readonly")
        sigma_0_3.config(state="readonly")
...
sigma_1_label_1 = tk.Label(text="omega [cm^-1]")
sigma_1_label_1.place(x=930, y=45)
sigma_1 = tk.Entry()
sigma_1.place(x=930, y=65)
sigma_1.insert(0, "521.604599812")

sigma_0_1_label_1 = tk.Label(text="sigma [cm^-1]")
sigma_0_1_label_1.place(x=930, y=85)
sigma_0_1 = tk.Entry()
sigma_0_1.place(x=930, y=105)
sigma_0_1.insert(0, "4.42010161931")
...
sigma_1_label_2 = tk.Label(text="omega [cm^-1]")
sigma_1_label_2.place(x=930, y=195)
sigma_2 = tk.Entry()
sigma_2.place(x=930, y=215)
sigma_2.insert(0, "480.0")

sigma_0_1_label_2 = tk.Label(text="sigma [cm^-1]")
sigma_0_1_label_2.place(x=930, y=235)
sigma_0_2 = tk.Entry()
sigma_0_2.place(x=930, y=255)
sigma_0_2.insert(0, "10")
...
sigma_1_label_3 = tk.Label(text="omega [cm^-1]")
sigma_1_label_3.place(x=930, y=340)
sigma_3 = tk.Entry()
sigma_3.place(x=930, y=360)
sigma_3.insert(0, "495.0")

sigma_0_1_label_3 = tk.Label(text="sigma [cm^-1]")
sigma_0_1_label_3.place(x=930, y=380)
sigma_0_3 = tk.Entry()
sigma_0_3.place(x=930, y=400)
sigma_0_3.insert(0, "5")
...
bg_label =tk.Label(text="background")
bg_label.place(x=670, y=370)
active_bg=tk.BooleanVar()
active_bg.set(True)
bg_active = tk.Checkbutton(text="active", variable=active_bg, state='disabled')
bg_active.place(x=670, y=400)
